<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Notificacion.aspx.vb" Inherits="SignaIR.Notificacion" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" value="Pedro" id="userenviar" /></td>
                </tr>
                <tr>
                    <td>Mensaje:</td>
                    <td>
                        <textarea id="mesaje">Mensaje enviado a Juan</textarea></td>
                </tr>
                <tr>
                    <td colspan="2">
            ...
            <table>
                <tr>
                    <td>Usuario a Notificar</td>
                    <td><input type="text" value="Juan" id="user" /></td>
                </tr>
            </table>
